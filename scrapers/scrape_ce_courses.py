...
PROGRAM_URL = "https://catalog.aucegypt.edu/preview_program.php?catoid=44&poid=8170"
OUTPUT_FILE = str((Path(__file__).parent / "../data/computer_engineering_courses.json").resolve())
